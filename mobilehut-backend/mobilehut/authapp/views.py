...
class AccountDetail(APIView):
    ...
    def post(self,request):
        ...
        index=0
        for order in order:
            order_details.append({"ordernumber":order.id,"orderdate":order.order_date,"orderstatus":order.order_status,"ordertracking":order.order_tracking,"shippingprovider":order.shipping_provider,"updateddate":order.update_date})
